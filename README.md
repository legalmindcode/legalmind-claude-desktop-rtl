...
הכלי מכוון ל-Claude Desktop בלבד, וזו החלטה מבוססת בדיקה ולא הנחה. בדקנו את אפליקציית ChatGPT לשולחן העבודה בווינדוס (חבילת OpenAI.Codex, שמכילה גם את ChatGPT וגם את Codex) עם אותו משפט מעורב בדיוק ובלי שום תו זריעה, **בשתי הלשוניות - Chat וגם Work**: בשתיהן העברית מוצגת נכון מלכתחילה, כולל יישור לימין. אין שם מה לתקן, והפעלת הכלי הזה עליהן רק תוסיף תו מיותר לטקסט. אם יום אחד זה ישתנה, ההתאמה היא שינוי של מחרוזת אחת בסקריפט - שם התהליך.
